...
HC165_t *_hc165 = NULL;
HC165_Status_t HC165_AssignPin(HC165_t *hc165, GPIO_TypeDef *port, uint16_t pin, HC165_PinName pinName) {
...
uint32_t HC165_ReadState(uint8_t n) {
	...
	data = 0;
	uint8_t value = 0;
	// Capture logic level of input pins, store it in shift register
